...
{
  template<typename T>
  std::string FormatArg(const T& arg)
  {
    std::stringstream ss;
    ss << arg;
    return ss.str();
  ...
  template<>
  std::string FormatArg<std::string>(const std::string& arg)
  {
    return arg;
  }
  
  template<>
  std::string FormatArg<std::vector<int>>(const std::vector<int>& arg)
  {
    return RayLogFormatter::FormatArray(arg);
  }
  
  template<>
  std::string FormatArg<std::vector<float>>(const std::vector<float>& arg)
  {
    return RayLogFormatter::FormatArray(arg);
  }
  ...
  template<>
  std::string FormatArg<bool>(const bool& arg)
  {
    return RayLogFormatter::FormatBool(arg);
  }
  
  template<>
  std::string FormatArg<void*>(void* const& arg)
  {
    return RayLogFormatter::FormatPtr(arg);
  }
  
  template<>
  std::string FormatArg<const void*>(const void* const& arg)
  {
    return RayLogFormatter::FormatPtr(arg);
  }
