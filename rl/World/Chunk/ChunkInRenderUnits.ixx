...
export enum class SystemHealth : uint32_t { HEALTHY = 0, DEGRADED = 1, UNHEALTHY = 2 };
...
export class ChunkInRenderUnits
{
  ...
  [[nodiscard]]
  TransactionResult WriteUnitId(const WorldChunkCoord& coord,
      int32_t                                          localX,
      int32_t                                          localY,
      int32_t                                          localZ,
      uint32_t                                         newUnitId);
