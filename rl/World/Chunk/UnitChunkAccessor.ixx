...
export struct UnitPosition
{
  ...
  {
    return UnitPosition(worldX + offset.worldX, worldY + offset.worldY, worldZ + offset.worldZ);
  }
...
export struct RelativeOffset
{
  ...
  static RelativeOffset Current() { return RelativeOffset(0, 0, 0); }
  static RelativeOffset Above() { return RelativeOffset(0, 1, 0); }
  static RelativeOffset Below() { return RelativeOffset(0, -1, 0); }
  static RelativeOffset North() { return RelativeOffset(0, 0, -1); }
  static RelativeOffset South() { return RelativeOffset(0, 0, 1); }
  static RelativeOffset East() { return RelativeOffset(1, 0, 0); }
  static RelativeOffset West() { return RelativeOffset(-1, 0, 0); }
  
  /* Diagonal directions */
  static RelativeOffset NorthEast() { return RelativeOffset(1, 0, -1); }
  static RelativeOffset NorthWest() { return RelativeOffset(-1, 0, -1); }
  static RelativeOffset SouthEast() { return RelativeOffset(1, 0, 1); }
  static RelativeOffset SouthWest() { return RelativeOffset(-1, 0, 1); }
  
  /* Convert to UnitPosition */
  [[nodiscard]]
  UnitPosition ToAbsolute(const UnitPosition& base) const
  {
    return UnitPosition(base.worldX + offsetX, base.worldY + offsetY, base.worldZ + offsetZ);
  }
};
...
export class UnitChunkAccessor
{
  ...
  [[nodiscard]]
  bool WorldToChunkLocal(const UnitPosition& worldPos, WorldChunkCoord& chunkCoord, 
                        int32_t& localX, int32_t& localY, int32_t& localZ) const;
};
