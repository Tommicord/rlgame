...
export struct CameraInputReceiver : Input::InputObserver
{
...
export class Camera : public AbstractCamera, public CameraInputReceiver, public IUpdatable
{
  public:
  Camera();
  ~Camera() override;
