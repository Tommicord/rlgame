...
bool UnitGrassGrowBehavior::TrySpread(Chunk::UnitChunkAccessor& accessor)
{
    ...
    Chunk::RelativeOffset directions[] = {
        Chunk::RelativeOffset::North(),     Chunk::RelativeOffset::South(),
        Chunk::RelativeOffset::East(),      Chunk::RelativeOffset::West(),
        Chunk::RelativeOffset::NorthEast(), Chunk::RelativeOffset::NorthWest(),
        Chunk::RelativeOffset::SouthEast(), Chunk::RelativeOffset::SouthWest()};
...
bool UnitGrassGrowBehavior::IsDirt(Chunk::UnitChunkAccessor&    accessor,
...
bool UnitGrassGrowBehavior::IsGrass(Chunk::UnitChunkAccessor&    accessor,
                                    const Chunk::RelativeOffset& offset) const
{
...
bool UnitGrassGrowBehavior::IsAir(Chunk::UnitChunkAccessor&    accessor,
                                  const Chunk::RelativeOffset& offset) const
{
    const auto result = accessor.ReadRelative(offset);
    if (!result.success)
...
bool UnitGrassGrowBehavior::SetGrass(Chunk::UnitChunkAccessor&    accessor,
...
bool UnitGrassGrowBehavior::SetAir(Chunk::UnitChunkAccessor&    accessor,
                                   const Chunk::RelativeOffset& offset)
{
