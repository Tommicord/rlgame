...
export constexpr int64_t DAY_DURATION_FRAGMENTS = DAY_DURATION_SECONDS * FRAGMENTS_PER_SECOND; // 120000
export constexpr int64_t NIGHT_DURATION_FRAGMENTS = NIGHT_DURATION_SECONDS * FRAGMENTS_PER_SECOND; // 110000
export constexpr int64_t FULL_CYCLE_FRAGMENTS = DAY_DURATION_FRAGMENTS + NIGHT_DURATION_FRAGMENTS; // 230000

/* Time of day enum */
export enum class TimeOfDay : uint8_t
{
  DAWN = 0,
  DAY = 1,
  DUSK = 2,
