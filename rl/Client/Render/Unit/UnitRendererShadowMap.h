...
void UnitCreateShadowMapFramebuffer(VkDevice device, VkImageView depthImageView,
    VkRenderPass renderPass, uint32_t width, uint32_t height, VkFramebuffer& framebuffer);
...
void UnitBeginShadowMapRenderPass(VkCommandBuffer commandBuffer, VkRenderPass renderPass,
