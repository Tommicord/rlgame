...
void UnitFillIndirectDrawBuffer(VkCommandBuffer commandBuffer, VkBuffer indirectDrawBuffer,
...
void UnitCopyVisibleCountToIndirectDraw(VkCommandBuffer commandBuffer, VkBuffer visibleCountBuffer,
