...
void UnitCreateCurvatureComputeDescriptorSetLayout(
    ...
    size_t                                                    lightingBufferSize)
{
  ...
  std::array descriptorWrites = {textureArrayWrite, lightingBufferWrite,
      lightingTextureWrite, settingsWrite, aoTextureWrite, normalTextureWrite,
