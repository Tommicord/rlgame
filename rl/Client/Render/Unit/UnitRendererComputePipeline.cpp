...
void UnitCreateComputePipelineLayout(VkDevice device,
    ...
    VkPipelineLayout&                         pipelineLayout)
{
  ...
  if (vkCreatePipelineLayout(
          device, &computePipelineLayoutInfo, nullptr, &pipelineLayout) != VK_SUCCESS)
  {
    ...
    VkDevice device, VkPipelineLayout pipelineLayout, VkPipeline& pipeline)
{
  ...
  if (vkCreateComputePipelines(device, VK_NULL_HANDLE, 1, &computePipelineInfo, nullptr,
          &pipeline) != VK_SUCCESS)
  {
