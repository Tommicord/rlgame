    ...
    VkPipelineLayout& pipelineLayout)
{
    ...
    if (vkCreatePipelineLayout(device, &graphicsPipelineLayoutInfo, nullptr, &pipelineLayout) != VK_SUCCESS)
    {
    ...
    VkPipeline& pipeline)
{
    ...
    auto vertShaderModule = ShaderObject::CreateShaderModule(device, vertShaderCode);
    auto fragShaderModule = ShaderObject::CreateShaderModule(device, fragShaderCode);
    ...
    ShaderObject::DestroyShaderModule(device, vertShaderModule);
    ShaderObject::DestroyShaderModule(device, fragShaderModule);
}
