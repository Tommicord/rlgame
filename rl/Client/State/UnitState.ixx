...
export struct UnitStateResource : StateResource
{
  World::BaseUnit* unit;
...
export struct UnitStateDrawableVulkan : StateDrawableVulkan
{
...
export class UnitStateDrawable : public StateDrawable<UnitStateResource, UnitStateDrawableVulkan>
{
  public:
...
export class UnitModel : public StateModel<World::BaseUnit,
                      UnitStateDrawable,
                      UnitStateResource,
