...
void Texture2::UploadTextureData(Main::MainBinding& context)
{
  ...
  vkBindBufferMemory(
      context.device, binding.vkStagingBuffer, binding.vkStagingBufferMemory, 0);
  ...
  if (mipmapLevels > 1)
  {
    ...
    for (uint32_t i = 1; i < static_cast<uint32_t>(mipmapLevels); i++)
    {
      ...
      vkCmdPipelineBarrier(commandBuffer, VK_PIPELINE_STAGE_TRANSFER_BIT,
          VK_PIPELINE_STAGE_TRANSFER_BIT, 0, 0, nullptr, 0, nullptr, 1, &mipBarrier);
      ...
      vkCmdBlitImage(commandBuffer, binding.vkImage, VK_IMAGE_LAYOUT_TRANSFER_SRC_OPTIMAL,
          binding.vkImage, VK_IMAGE_LAYOUT_TRANSFER_DST_OPTIMAL, 1, &blit,
          VK_FILTER_LINEAR);
    ...
    vkCmdPipelineBarrier(commandBuffer, VK_PIPELINE_STAGE_TRANSFER_BIT,
        VK_PIPELINE_STAGE_FRAGMENT_SHADER_BIT, 0, 0, nullptr, 0, nullptr, 1, &mipBarrier);
