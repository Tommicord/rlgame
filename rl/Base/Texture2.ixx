...
public:
    ...
    bool
    FromMemory(const uint8_t* data, size_t size, const Texture2Properties& properties);
...
export Texture2* GenerateLightningTexture(Texture2*                 baseTexture,
                                          const Texture2Properties& properties);
export Texture2* GenerateDirectionalLightTexture(const Texture2*           baseTexture,
                                                 const glm::vec3&          lightDirection,
                                                 const Texture2Properties& properties);
export Texture2* GenerateNormalTexture(Texture2*                 baseTexture,
                                       const Texture2Properties& properties);
