...
Texture2* GenerateLightningTexture(Texture2*                 baseTexture,
                                   const Texture2Properties& properties)
{
    ...
    for (int y = 0; y < height; ++y)
    {
        for (int x = 0; x < width; ++x)
        {
            ...
            {
                luminance = 0.299f * baseData[baseIndex] +
                            0.587f * baseData[baseIndex + 1] +
    ...
    lightningTexture->FromData(lightningData, width, height, Texture2Format::R8,
                               lightningProps);
                                          ...
                                          const Texture2Properties& properties)
{
        ...
        for (int x = 0; x < width; ++x)
        {
            ...
            if (x > 0 && x < width - 1 && y > 0 && y < height - 1)
            {
                ...
                if (leftIndex >= 0 && leftIndex < baseDataSize && rightIndex >= 0 &&
                    rightIndex < baseDataSize && topIndex >= 0 &&
                    topIndex < baseDataSize && bottomIndex >= 0 &&
                    bottomIndex < baseDataSize)
                {
    ...
    lightingTexture->FromData(lightingData, width, height, Texture2Format::RGB8,
                              lightingProps);
