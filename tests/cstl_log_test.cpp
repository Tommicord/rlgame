...
TEST (CstlLogInitTest, InitFailsWithoutHeap) { EXPECT_EQ (-1, R_CSTL_LogInit ()); }
...
TEST_F (CstlLogTest, DefaultMinLevelIsTrace) { EXPECT_EQ (R_CSTL_LOG_LEVEL_TRACE, R_CSTL_LogGetMinLevel ()); }
