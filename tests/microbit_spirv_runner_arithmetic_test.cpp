...
class MicrobitSpirvRunnerArithmeticTest : public ::testing::Test {
protected:
    void SetUp() override {
...
TEST_F(MicrobitSpirvRunnerArithmeticTest, IAdd_Scalar) {
    const uint32_t spv[] = {
    ...
    EXPECT_EQ(8u, result->cpuWords[0]);  // 5 + 3

    Cleanup(exec, rprog, prog, ctx);
}

TEST_F(MicrobitSpirvRunnerArithmeticTest, FAdd_Scalar) {
    const uint32_t spv[] = {
        0x07230203, 0x00010500, 0x000d000b, 0x00000020, 0x00000000,
        0x00020011, 0x00000001,
        0x00030003, 0x0000000a, 0x000001c2,
        ...
        0x00050041, 0x0000000c, 0x00000013, 0x00000011, 0x00000012,
        0x000200f8, 0x0000000f,
    };
    ...
    ASSERT_NE(nullptr, result);
    float val = 0.0f;
    memcpy(&val, &result->cpuWords[0], sizeof(float));
    EXPECT_FLOAT_EQ(3.0f, val);  // 1.0 + 2.0

    Cleanup(exec, rprog, prog, ctx);
}

TEST_F(MicrobitSpirvRunnerArithmeticTest, ISub_Scalar) {
    const uint32_t spv[] = {
        0x07230203, 0x00010500, 0x000d000b, 0x00000020, 0x00000000,
        0x00020011, 0x00000001,
        0x00030003, 0x0000000a, 0x000001c2,
        ...
        0x00050051, 0x0000000c, 0x00000010, 0x00000005, 0x00000000,
        0x00050051, 0x0000000c, 0x00000011, 0x00000005, 0x00000003,
        0x00050042, 0x0000000c, 0x00000012, 0x00000010, 0x00000011,
        0x000200f8, 0x0000000f,
    };
    ...
    struct R_Microbit_SpirvParserResult* result = R_Microbit_SpirvParserStateGetResult(exec->pState, "12");
    ASSERT_NE(nullptr, result);
    EXPECT_EQ(2u, result->cpuWords[0]);  // 5 - 3

    Cleanup(exec, rprog, prog, ctx);
}

TEST_F(MicrobitSpirvRunnerArithmeticTest, IMul_Scalar) {
    const uint32_t spv[] = {
        0x07230203, 0x00010500, 0x000d000b, 0x00000020, 0x00000000,
        0x00020011, 0x00000001,
        0x00030003, 0x0000000a, 0x000001c2,
        ...
        0x00050051, 0x0000000c, 0x00000010, 0x00000005, 0x00000000,
        0x00050051, 0x0000000c, 0x00000011, 0x00000005, 0x00000003,
        0x00050043, 0x0000000c, 0x00000012, 0x00000010, 0x00000011,
        0x000200f8, 0x0000000f,
    };
    ...
    struct R_Microbit_SpirvParserResult* result = R_Microbit_SpirvParserStateGetResult(exec->pState, "12");
    ASSERT_NE(nullptr, result);
    EXPECT_EQ(15u, result->cpuWords[0]);  // 5 * 3

    Cleanup(exec, rprog, prog, ctx);
}

TEST_F(MicrobitSpirvRunnerArithmeticTest, UDiv_Scalar) {
    const uint32_t spv[] = {
        0x07230203, 0x00010500, 0x000d000b, 0x00000020, 0x00000000,
        0x00020011, 0x00000001,
        0x00030003, 0x0000000a, 0x000001c2,
        ...
        0x00050051, 0x0000000c, 0x00000010, 0x00000005, 0x00000000,
        0x00050051, 0x0000000c, 0x00000011, 0x00000005, 0x00000003,
        0x00050046, 0x0000000c, 0x00000012, 0x00000010, 0x00000011,
        0x000200f8, 0x0000000f,
    };
    ...
    struct R_Microbit_SpirvParserResult* result = R_Microbit_SpirvParserStateGetResult(exec->pState, "12");
    ASSERT_NE(nullptr, result);
    EXPECT_EQ(1u, result->cpuWords[0]);  // 5 / 3 = 1

    Cleanup(exec, rprog, prog, ctx);
}

TEST_F(MicrobitSpirvRunnerArithmeticTest, UMod_Scalar) {
    const uint32_t spv[] = {
        0x07230203, 0x00010500, 0x000d000b, 0x00000020, 0x00000000,
        0x00020011, 0x00000001,
        0x00030003, 0x0000000a, 0x000001c2,
        ...
        0x00050051, 0x0000000c, 0x00000010, 0x00000005, 0x00000000,
        0x00050051, 0x0000000c, 0x00000011, 0x00000005, 0x00000003,
        0x00050049, 0x0000000c, 0x00000012, 0x00000010, 0x00000011,
        0x000200f8, 0x0000000f,
    };
    ...
    struct R_Microbit_SpirvParserResult* result = R_Microbit_SpirvParserStateGetResult(exec->pState, "12");
    ASSERT_NE(nullptr, result);
    EXPECT_EQ(2u, result->cpuWords[0]);  // 5 % 3 = 2

    Cleanup(exec, rprog, prog, ctx);
}

TEST_F(MicrobitSpirvRunnerArithmeticTest, FDiv_Scalar) {
    const uint32_t spv[] = {
        0x07230203, 0x00010500, 0x000d000b, 0x00000020, 0x00000000,
        0x00020011, 0x00000001,
        0x00030003, 0x0000000a, 0x000001c2,
        ...
        0x00050051, 0x0000000c, 0x00000011, 0x00000005, 0x00000000,
        0x00050051, 0x0000000c, 0x00000012, 0x00000005, 0x00000000,
        0x00050048, 0x0000000c, 0x00000013, 0x00000011, 0x00000012,
        0x000200f8, 0x0000000f,
    };
    ...
    float val = 0.0f;
    memcpy(&val, &result->cpuWords[0], sizeof(float));
    EXPECT_FLOAT_EQ(0.5f, val);  // 1.0 / 2.0

    Cleanup(exec, rprog, prog, ctx);
}

TEST_F(MicrobitSpirvRunnerArithmeticTest, Vector_IAdd) {
    const uint32_t spv[] = {
        0x07230203, 0x00010500, 0x000d000b, 0x00000020, 0x00000000,
        0x00020011, 0x00000001,
        0x00030003, 0x0000000a, 0x000001c2,
    ...
    EXPECT_EQ(14u, result->cpuWords[1]);  // (5,7) + (3,5) = (8,12)? Wait: (5,7)+(3,5)=(8,12)
