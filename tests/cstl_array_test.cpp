...
TEST_F (CstlArrayTest, RevBytesRejectsNullArray) { EXPECT_EQ (-1, R_CSTL_ArrayRevBytes (nullptr, 32)); }

TEST_F (CstlArrayTest, PushRejectsNullArray) { EXPECT_EQ (-1, R_CSTL_ArrayPush (nullptr, 42)); }
...
TEST_F (CstlArrayTest, UnshiftRejectsNullArray) { EXPECT_EQ (-1, R_CSTL_ArrayUnshift (nullptr, 42)); }

TEST_F (CstlArrayTest, ClearRejectsNullArray) { EXPECT_EQ (-1, R_CSTL_ArrayClear (nullptr, 1)); }

TEST_F (CstlArrayTest, FillRejectsNullArray) { EXPECT_EQ (-1, R_CSTL_ArrayFill (nullptr, 0xFF)); }
