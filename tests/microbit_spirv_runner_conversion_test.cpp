...
class MicrobitSpirvRunnerConversionTest : public ::testing::Test {
protected:
    void SetUp() override {
...
TEST_F(MicrobitSpirvRunnerConversionTest, ConvertFToU_Scalar) {
    const uint32_t spv[] = {
        ...
        0x0005004d, 0x0000000c, 0x00000012, 0x00000011, 0x00000010,
...
TEST_F(MicrobitSpirvRunnerConversionTest, ConvertSToF_Scalar) {
    const uint32_t spv[] = {
        0x07230203, 0x00010500, 0x000d000b, 0x00000020, 0x00000000,
        0x00020011, 0x00000001,
        0x00030003, 0x0000000a, 0x000001c2,
        ...
        0x00040036, 0x00000010, 0x00000014, 0x0000000c,
        0x00050051, 0x0000000c, 0x00000011, 0x00000005, 0x00000000,
        0x0005004f, 0x0000000c, 0x00000012, 0x00000011, 0x00000010,
        0x000200f8, 0x0000000f,
    };
    ...
    EXPECT_FLOAT_EQ(3.0f, val);

    Cleanup(exec, rprog, prog, ctx);
}

TEST_F(MicrobitSpirvRunnerConversionTest, ConvertUToF_Scalar) {
    const uint32_t spv[] = {
        0x07230203, 0x00010500, 0x000d000b, 0x00000020, 0x00000000,
        0x00020011, 0x00000001,
        0x00030003, 0x0000000a, 0x000001c2,
        ...
        0x00040036, 0x00000010, 0x00000014, 0x0000000c,
        0x00050051, 0x0000000c, 0x00000011, 0x00000005, 0x00000000,
        0x00050050, 0x0000000c, 0x00000012, 0x00000011, 0x00000010,
        0x000200f8, 0x0000000f,
    };
...
TEST_F(MicrobitSpirvRunnerConversionTest, SConvert_Truncate) {
    const uint32_t spv[] = {
        0x07230203, 0x00010500, 0x000d000b, 0x00000020, 0x00000000,
        0x00020011, 0x00000001,
        0x00030003, 0x0000000a, 0x000001c2,
        ...
        0x00040036, 0x00000010, 0x00000014, 0x0000000c,
        0x00050051, 0x0000000c, 0x00000011, 0x00000005, 0x00000000,
        0x00050052, 0x0000000c, 0x00000012, 0x00000011, 0x00000010,
        0x000200f8, 0x0000000f,
    };
...
TEST_F(MicrobitSpirvRunnerConversionTest, Bitcast_FloatToInt) {
    const uint32_t spv[] = {
        0x07230203, 0x00010500, 0x000d000b, 0x00000020, 0x00000000,
        0x00020011, 0x00000001,
        0x00030003, 0x0000000a, 0x000001c2,
        ...
        0x00040036, 0x00000010, 0x00000014, 0x0000000c,
        0x00050051, 0x0000000c, 0x00000011, 0x00000005, 0x00000000,
        0x00050047, 0x0000000c, 0x00000012, 0x00000011, 0x00000010,
        0x000200f8, 0x0000000f,
    };
    ...
    struct R_Microbit_SpirvParserResult* result = R_Microbit_SpirvParserStateGetResult(exec->pState, "12");
    ASSERT_NE(nullptr, result);
    EXPECT_EQ(0x3F800000u, result->cpuWords[0]);  // 1.0f as bits
