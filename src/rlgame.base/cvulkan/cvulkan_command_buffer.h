 ...
 */
struct r_cvulkan_pipeline_barrier_info
{
 ...
 */
struct r_cvulkan_render_pass_begin_info
{
 ...
 */
struct r_cvulkan_dynamic_rendering_attachment_info
{
 ...
 */
R_CVULKAN_API enum R_CVulkan_Error r_cvulkan_new_command_buffer (
 ...
 */
R_CVULKAN_API void r_cvulkan_delete_command_buffer (struct R_CVulkan_CommandBuffer* pCommandBuffer);
 ...
 * @return R_CVULKAN_OK on success, error code otherwise
 */
R_CVULKAN_API enum R_CVulkan_Error r_cvulkan_begin_command_buffer (
    struct R_CVulkan_CommandBuffer*       pCommandBuffer,
 ...
 * @return R_CVULKAN_OK on success, error code otherwise
 */
R_CVULKAN_API enum R_CVulkan_Error r_cvulkan_reset_command_buffer (
    struct R_CVulkan_CommandBuffer* pCommandBuffer,
 ...
 * @return R_CVULKAN_OK on success, error code otherwise
 */
R_CVULKAN_API enum R_CVulkan_Error r_cvulkan_command_buffer_bind_pipeline (
    struct R_CVulkan_CommandBuffer* pCommandBuffer,
 ...
 * @return R_CVULKAN_OK on success, error code otherwise
 */
R_CVULKAN_API enum R_CVulkan_Error r_cvulkan_command_buffer_bind_vertex_buffer (
    struct R_CVulkan_CommandBuffer* pCommandBuffer,
 ...
 * @return R_CVULKAN_OK on success, error code otherwise
 */
R_CVULKAN_API enum R_CVulkan_Error r_cvulkan_command_buffer_bind_index_buffer (
    struct R_CVulkan_CommandBuffer* pCommandBuffer,
    VkBuffer                        buffer,
    VkDeviceSize                    offset,
 ...
 * @return R_CVULKAN_OK on success, error code otherwise
 */
R_CVULKAN_API enum R_CVulkan_Error r_cvulkan_command_buffer_bind_descriptor_sets (
    struct R_CVulkan_CommandBuffer* pCommandBuffer,
    VkPipelineBindPoint             pipelineBindPoint,
 ...
 * @return R_CVULKAN_OK on success, error code otherwise
 */
R_CVULKAN_API enum R_CVulkan_Error r_cvulkan_command_buffer_draw (
    struct R_CVulkan_CommandBuffer* pCommandBuffer,
 ...
 * @return R_CVULKAN_OK on success, error code otherwise
 */
R_CVULKAN_API enum R_CVulkan_Error r_cvulkan_command_buffer_draw_indexed (
    struct R_CVulkan_CommandBuffer* pCommandBuffer,
    uint32_t                        indexCount,
    uint32_t                        instanceCount,
    uint32_t                        firstIndex,
 ...
 * @return R_CVULKAN_OK on success, error code otherwise
 */
R_CVULKAN_API enum R_CVulkan_Error r_cvulkan_command_buffer_set_viewport (
    struct R_CVulkan_CommandBuffer* pCommandBuffer,
 ...
 * @return R_CVULKAN_OK on success, error code otherwise
 */
R_CVULKAN_API enum R_CVulkan_Error r_cvulkan_command_buffer_set_scissor (
 ...
 * @return R_CVULKAN_OK on success, error code otherwise
 */
R_CVULKAN_API enum R_CVulkan_Error r_cvulkan_command_buffer_set_blend_constants (
    struct R_CVulkan_CommandBuffer* pCommandBuffer,
 ...
 * @return R_CVULKAN_OK on success, error code otherwise
 */
R_CVULKAN_API enum R_CVulkan_Error r_cvulkan_command_buffer_set_depth_bounds (
    struct R_CVulkan_CommandBuffer* pCommandBuffer,
    float                           minDepth,
    float                           maxDepth);
 ...
 * @return R_CVULKAN_OK on success, error code otherwise
 */
R_CVULKAN_API enum R_CVulkan_Error r_cvulkan_command_buffer_set_stencil_compare_mask (
    struct R_CVulkan_CommandBuffer* pCommandBuffer,
 ...
 * @return R_CVULKAN_OK on success, error code otherwise
 */
R_CVULKAN_API enum R_CVulkan_Error r_cvulkan_command_buffer_set_stencil_write_mask (
    struct R_CVulkan_CommandBuffer* pCommandBuffer,
    VkStencilFaceFlags              faceMask,
    uint32_t                        writeMask);
 ...
 * @return R_CVULKAN_OK on success, error code otherwise
 */
R_CVULKAN_API enum R_CVulkan_Error r_cvulkan_command_buffer_set_stencil_reference (
    struct R_CVulkan_CommandBuffer* pCommandBuffer,
    VkStencilFaceFlags              faceMask,
    uint32_t                        reference);
 ...
 * @return R_CVULKAN_OK on success, error code otherwise
 */
R_CVULKAN_API enum R_CVulkan_Error r_cvulkan_command_buffer_copy_buffer (
    struct R_CVulkan_CommandBuffer* pCommandBuffer,
    VkBuffer                        srcBuffer,
    VkBuffer                        dstBuffer,
 ...
 * @return R_CVULKAN_OK on success, error code otherwise
 */
R_CVULKAN_API enum R_CVulkan_Error r_cvulkan_command_buffer_copy_buffer_to_image (
    struct R_CVulkan_CommandBuffer* pCommandBuffer,
    VkBuffer                        srcBuffer,
    VkImage                         dstImage,
 ...
 * @return R_CVULKAN_OK on success, error code otherwise
 */
R_CVULKAN_API enum R_CVulkan_Error r_cvulkan_command_buffer_copy_image_to_buffer (
    struct R_CVulkan_CommandBuffer* pCommandBuffer,
    VkImage                         srcImage,
 ...
 * @return R_CVULKAN_OK on success, error code otherwise
 */
R_CVULKAN_API enum R_CVulkan_Error r_cvulkan_command_buffer_pipeline_barrier (
    struct R_CVulkan_CommandBuffer*             pCommandBuffer,
 ...
 * @return R_CVULKAN_OK on success, error code otherwise
 */
R_CVULKAN_API enum R_CVulkan_Error r_cvulkan_command_buffer_begin_render_pass (
    struct R_CVulkan_CommandBuffer*             pCommandBuffer,
 ...
 * @return R_CVULKAN_OK on success, error code otherwise
 */
R_CVULKAN_API enum R_CVulkan_Error r_cvulkan_command_buffer_begin_rendering (
    struct R_CVulkan_CommandBuffer*              pCommandBuffer,
 ...
 * @return R_CVULKAN_OK on success, error code otherwise
 */
R_CVULKAN_API enum R_CVulkan_Error r_cvulkan_command_buffer_next_subpass (
    struct R_CVulkan_CommandBuffer* pCommandBuffer,
 ...
 * @return R_CVULKAN_OK on success, error code otherwise
 */
R_CVULKAN_API enum R_CVulkan_Error r_cvulkan_command_buffer_push_constants (
    struct R_CVulkan_CommandBuffer* pCommandBuffer,
    VkPipelineLayout                layout,
 ...
 * @return R_CVULKAN_OK on success, error code otherwise
 */
R_CVULKAN_API enum R_CVulkan_Error r_cvulkan_command_buffer_dispatch (
    struct R_CVulkan_CommandBuffer* pCommandBuffer,
 ...
 * @return R_CVULKAN_OK on success, error code otherwise
 */
R_CVULKAN_API enum R_CVulkan_Error r_cvulkan_command_buffer_dispatch_indirect (
    struct R_CVulkan_CommandBuffer* pCommandBuffer,
    VkBuffer                        buffer,
    VkDeviceSize                    offset);
