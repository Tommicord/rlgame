    ...
    const struct R_CVulkan_Fence*         pFence)
{
        ...
        {
                nativeWaitSemaphores
                    = (VkSemaphore*)R_CSTL_HeapAlloc (waitSemaphoreCount * sizeof (VkSemaphore));
                ...
                nativeWaitStageMask = (VkPipelineStageFlags*)R_CSTL_HeapAlloc (
                    waitSemaphoreCount * sizeof (VkPipelineStageFlags));
