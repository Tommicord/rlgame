...
typedef void (
    *r_game_lifecycle_before_each) (void* pDrawable, const void* pResource, const size_t resourceSize);

typedef void (
    *r_game_lifecycle_after_each) (void* pDrawable, const void* pResource, const size_t resourceSize);

typedef void (
    *r_game_lifecycle_before_pass) (void* pDrawable, const void* pResource, const size_t resourceSize);

typedef void (*r_game_lifecycle_pause) (void* pDrawable, const void* pResource, const size_t resourceSize);

typedef void (
    *r_game_lifecycle_after_pass) (void* pDrawable, const void* pResource, const size_t resourceSize);
...
R_GAME_API int r_game_renderer_set_layer_enabled (
    struct r_game_renderer_subsystem* pSubsystem,
    uint32_t                          layerIndex,
    int                               enabled);
...
R_GAME_API const void* r_game_renderer_get_resource (
    struct r_game_renderer_subsystem* pSubsystem,
    r_game_renderer_resource_handle   handle);
