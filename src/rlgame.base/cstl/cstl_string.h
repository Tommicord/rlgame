 ...
 */
R_CSTL_API int R_CSTL_StringEquals (const struct R_CSTL_String* pLeft, const struct R_CSTL_String* pRight);
 ...
 */
R_CSTL_API int R_CSTL_StringCompare (const struct R_CSTL_String* pLeft, const struct R_CSTL_String* pRight);
 ...
 */
R_CSTL_API struct R_CSTL_String* R_CSTL_StringConcat (const struct R_CSTL_String* pLeft,
 ...
 */
R_CSTL_API int R_CSTL_StringEqualsIgnoreCase (const struct R_CSTL_String* pLeft,
                                               const struct R_CSTL_String* pRight);
 ...
 */
R_CSTL_API int R_CSTL_StringCompareIgnoreCase (const struct R_CSTL_String* pLeft,
                                                 const struct R_CSTL_String* pRight);
 ...
 */
R_CSTL_API struct R_CSTL_String* R_CSTL_StringJoin (const struct R_CSTL_String* pStringDelimiter,
 ...
 */
R_CSTL_API int R_CSTL_StringCopy (struct R_CSTL_String* R_CSTL_RESTRICT       pDst,
 ...
 * @return R_CSTL_ERROR_OK on success, error code on failure.
 */
R_CSTL_API int R_CSTL_StringBuilderEnsureCapacity (R_CSTL_StringBuilder* pBuilder,
 ...
 * @return R_CSTL_ERROR_OK on success, error code on failure.
 */
R_CSTL_API int R_CSTL_StringBuilderAppend (R_CSTL_StringBuilder* pBuilder,
 ...
 * @return R_CSTL_ERROR_OK on success, error code on failure.
 */
R_CSTL_API int R_CSTL_StringBuilderEmplaceSized (R_CSTL_StringBuilder* pBuilder,
                                                  const char*           pCString,
                                                  const size_t          size);
 ...
 * @return R_CSTL_ERROR_OK on success, error code on failure.
 */
R_CSTL_API int R_CSTL_StringBuilderAppendData (R_CSTL_StringBuilder* pBuilder,
                                                const char*           pData,
                                                const size_t          length);
 ...
 * @return R_CSTL_ERROR_OK on success, error code on failure.
 */
R_CSTL_API int R_CSTL_StringBuilderInsert (R_CSTL_StringBuilder* pBuilder,
                                            size_t                offset,
                                            const struct R_CSTL_String*  pString);
 ...
 * @return R_CSTL_ERROR_OK on success, error code on failure.
 */
R_CSTL_API int R_CSTL_StringBuilderEmplaceInsert (R_CSTL_StringBuilder* pBuilder,
                                                   size_t                offset,
                                                   const char*           pCString);
 ...
 * @return R_CSTL_ERROR_OK on success, error code on failure.
 */
R_CSTL_API int R_CSTL_StringBuilderReplace (R_CSTL_StringBuilder* pBuilder,
                                             size_t                start,
                                             size_t                end,
                                             const struct R_CSTL_String*  pString);
 ...
 * @return R_CSTL_ERROR_OK on success, error code on failure.
 */
R_CSTL_API int R_CSTL_StringBuilderEmplaceReplace (R_CSTL_StringBuilder* pBuilder,
                                                    size_t                start,
                                                    size_t                end,
                                                    const char*           pString);
