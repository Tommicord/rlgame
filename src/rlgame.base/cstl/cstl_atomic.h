...
R_CSTL_API int R_CSTL_AtomicInt32Increment (R_CSTL_AtomicInt32* pAtomic);

R_CSTL_API int R_CSTL_AtomicInt32Decrement (R_CSTL_AtomicInt32* pAtomic);

R_CSTL_API int R_CSTL_AtomicInt32CompareExchange (R_CSTL_AtomicInt32* pAtomic, int expected, int desired);

R_CSTL_API int R_CSTL_AtomicInt32Exchange (R_CSTL_AtomicInt32* pAtomic, int value);

R_CSTL_API int R_CSTL_AtomicInt32Load (const R_CSTL_AtomicInt32* pAtomic);

R_CSTL_API void R_CSTL_AtomicInt32Store (R_CSTL_AtomicInt32* pAtomic, int value);

R_CSTL_API int R_CSTL_AtomicInt32Add (R_CSTL_AtomicInt32* pAtomic, int value);

R_CSTL_API uint32_t R_CSTL_AtomicUint32Increment (R_CSTL_AtomicUint32* pAtomic);

R_CSTL_API uint32_t R_CSTL_AtomicUint32Decrement (R_CSTL_AtomicUint32* pAtomic);

R_CSTL_API uint32_t
R_CSTL_AtomicUint32CompareExchange (R_CSTL_AtomicUint32* pAtomic, uint32_t expected, uint32_t desired);

R_CSTL_API uint32_t R_CSTL_AtomicUint32Exchange (R_CSTL_AtomicUint32* pAtomic, uint32_t value);

R_CSTL_API uint32_t R_CSTL_AtomicUint32Load (const R_CSTL_AtomicUint32* pAtomic);

R_CSTL_API void R_CSTL_AtomicUint32Store (R_CSTL_AtomicUint32* pAtomic, uint32_t value);

R_CSTL_API uint32_t R_CSTL_AtomicUint32Add (R_CSTL_AtomicUint32* pAtomic, uint32_t value);

R_CSTL_API int64_t R_CSTL_AtomicInt64Increment (R_CSTL_AtomicInt64* pAtomic);

R_CSTL_API int64_t R_CSTL_AtomicInt64Decrement (R_CSTL_AtomicInt64* pAtomic);

R_CSTL_API int64_t
R_CSTL_AtomicInt64CompareExchange (R_CSTL_AtomicInt64* pAtomic, int64_t expected, int64_t desired);

R_CSTL_API int64_t R_CSTL_AtomicInt64Exchange (R_CSTL_AtomicInt64* pAtomic, int64_t value);

R_CSTL_API int64_t R_CSTL_AtomicInt64Load (const R_CSTL_AtomicInt64* pAtomic);

R_CSTL_API void R_CSTL_AtomicInt64Store (R_CSTL_AtomicInt64* pAtomic, int64_t value);

R_CSTL_API int64_t R_CSTL_AtomicInt64Add (R_CSTL_AtomicInt64* pAtomic, int64_t value);

R_CSTL_API uint64_t R_CSTL_AtomicUint64Increment (R_CSTL_AtomicUint64* pAtomic);

R_CSTL_API uint64_t R_CSTL_AtomicUint64Decrement (R_CSTL_AtomicUint64* pAtomic);

R_CSTL_API uint64_t
R_CSTL_AtomicUint64CompareExchange (R_CSTL_AtomicUint64* pAtomic, uint64_t expected, uint64_t desired);

R_CSTL_API uint64_t R_CSTL_AtomicUint64Exchange (R_CSTL_AtomicUint64* pAtomic, uint64_t value);

R_CSTL_API uint64_t R_CSTL_AtomicUint64Load (const R_CSTL_AtomicUint64* pAtomic);

R_CSTL_API void R_CSTL_AtomicUint64Store (R_CSTL_AtomicUint64* pAtomic, uint64_t value);

R_CSTL_API uint64_t R_CSTL_AtomicUint64Add (R_CSTL_AtomicUint64* pAtomic, uint64_t value);

R_CSTL_API void* R_CSTL_AtomicPtrCompareExchange (R_CSTL_AtomicPtr* pAtomic, void* expected, void* desired);

R_CSTL_API void* R_CSTL_AtomicPtrExchange (R_CSTL_AtomicPtr* pAtomic, void* value);

R_CSTL_API void* R_CSTL_AtomicPtrLoad (const R_CSTL_AtomicPtr* pAtomic);

R_CSTL_API void R_CSTL_AtomicPtrStore (R_CSTL_AtomicPtr* pAtomic, void* value);
...
R_CSTL_API void* R_CSTL_AtomicPtrCompareExchange (R_CSTL_AtomicVoidP* pAtomic, void* expected, void* desired);

R_CSTL_API void* R_CSTL_AtomicPtrExchange (R_CSTL_AtomicVoidP* pAtomic, void* value);

R_CSTL_API void* R_CSTL_AtomicPtrLoad (const R_CSTL_AtomicVoidP* pAtomic);

R_CSTL_API void R_CSTL_AtomicPtrStore (R_CSTL_AtomicVoidP* pAtomic, void* value);
