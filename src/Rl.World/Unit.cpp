...
bool PreUnit::matchesRequirements(float elevation, float equator, float moisture,
...
std::string PreUnit::toString() const
{
        ...
        snprintf(buffer, sizeof(buffer),
                 ...
                 prop->elevationStart, prop->elevationEnd, prop->flammability,
                 prop->explosionResistance);
