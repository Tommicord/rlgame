    ...
    : public PreRegistry<PreBiome, PreBiomeBucket, PreBiomeBucketKey, PreBiomeBucketKeyHash>
{
        public:
                ...
                const std::vector<PreBiome*>&
                getBucket(const PreBiomeBucketKey& key) const override;
                ...
                std::vector<PreBiome*> biomesByCondition(float elevation,
                                                         float equator,
                                                         float moisture,
                                                         float temperature);
        ...
        private:
                 ...
                 * @return The generated bucket key */
                PreBiomeBucketKey genConditionKey(float elevation,
                                                  float equator,
                                                  float moisture,
