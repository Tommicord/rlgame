...
struct PrePlanetBucketKey
{
    ...
    {
      return baseTemperature == other.baseTemperature && baseMoisture == other.baseMoisture &&
    ...
    : public PreRegistry<PrePlanet, PrePlanetBucket, PrePlanetBucketKey, PrePlanetBucketKeyHash>
{
  public:
    ...
    const std::vector<PrePlanet*>& getBucket(const PrePlanetBucketKey& key) const override;
