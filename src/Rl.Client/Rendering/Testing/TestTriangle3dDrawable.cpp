...
void TestTriangle3dDrawable::setup(GameDeviceInstance& instance)
{
        ...
        memoryAllocator =
            GameVulkanMemoryAllocator(instance.getDevice(), instance.getPhysicalDevice());
        ...
        vertShaderModule = GameShaderLoader::createShaderModule(
            instance.getDevice(), Triangle3dVert_data, Triangle3dVert_size);
        fragShaderModule = GameShaderLoader::createShaderModule(
            instance.getDevice(), Triangle3dFrag_data, Triangle3dFrag_size);
        ...
        if (vkCreatePipelineLayout(instance.getDevice(), &pipelineLayoutInfo, nullptr,
        ...
        if (vkCreateGraphicsPipelines(instance.getDevice(), VK_NULL_HANDLE, 1, &pipelineInfo,
