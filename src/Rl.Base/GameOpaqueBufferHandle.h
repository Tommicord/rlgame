...
{
  return static_cast<GameOpaqueBufferUsage>(static_cast<uint32_t>(a) | static_cast<uint32_t>(b));
}
...
struct GameOpaqueBufferHandle
{
    ...
    GameOpaqueBufferMemoryProperty memoryProperty = GameOpaqueBufferMemoryProperty::None;
    uint32_t                       stride         = 0;
