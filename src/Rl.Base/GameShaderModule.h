...
struct GameShaderModule
{
                ...
                GameShaderModule(VkDevice device, VkShaderModule module) :
                    device(device), shaderModule(module)
                {
                }
...
{
        public:
                static GameShaderModule
                createShaderModule(VkDevice device, const uint32_t* code, size_t size);
};
