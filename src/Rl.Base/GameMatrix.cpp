...
float Mat4::determinant() const
{
  ...
  det += m[0] * (m[5] * (m[10] * m[15] - m[11] * m[14]) - m[6] * (m[9] * m[15] - m[11] * m[13]) +
                 m[7] * (m[9] * m[14] - m[10] * m[13]));

  // Cofactor for element (0,1)
  det -= m[1] * (m[4] * (m[10] * m[15] - m[11] * m[14]) - m[6] * (m[8] * m[15] - m[11] * m[12]) +
                 m[7] * (m[8] * m[14] - m[10] * m[12]));

  // Cofactor for element (0,2)
  det += m[2] * (m[4] * (m[9] * m[15] - m[11] * m[13]) - m[5] * (m[8] * m[15] - m[11] * m[12]) +
                 m[7] * (m[8] * m[13] - m[9] * m[12]));

  // Cofactor for element (0,3)
  det -= m[3] * (m[4] * (m[9] * m[14] - m[10] * m[13]) - m[5] * (m[8] * m[14] - m[10] * m[12]) +
...
Mat4 Mat4::inverse() const
{
  ...
  result.m[0] = (m[5] * (m[10] * m[15] - m[11] * m[14]) - m[6] * (m[9] * m[15] - m[11] * m[13]) +
                 m[7] * (m[9] * m[14] - m[10] * m[13])) *
                invDet;

  result.m[1] = (m[1] * (m[10] * m[15] - m[11] * m[14]) - m[2] * (m[9] * m[15] - m[11] * m[13]) +
  ...
  result.m[4] = (m[4] * (m[10] * m[15] - m[11] * m[14]) - m[6] * (m[8] * m[15] - m[11] * m[12]) +
                 m[7] * (m[8] * m[14] - m[10] * m[12])) *
                -invDet;

  result.m[5] = (m[0] * (m[10] * m[15] - m[11] * m[14]) - m[2] * (m[8] * m[15] - m[11] * m[12]) +
  ...
  result.m[8] = (m[4] * (m[9] * m[15] - m[11] * m[13]) - m[5] * (m[8] * m[15] - m[11] * m[12]) +
                 m[7] * (m[8] * m[13] - m[9] * m[12])) *
                invDet;

  result.m[9] = (m[0] * (m[9] * m[15] - m[11] * m[13]) - m[1] * (m[8] * m[15] - m[11] * m[12]) +
                 m[3] * (m[8] * m[13] - m[9] * m[12])) *
                -invDet;

  result.m[10] = (m[0] * (m[5] * m[15] - m[7] * m[13]) - m[1] * (m[4] * m[15] - m[7] * m[12]) +
  ...
  result.m[12] = (m[4] * (m[9] * m[14] - m[10] * m[13]) - m[5] * (m[8] * m[14] - m[10] * m[12]) +
                  m[6] * (m[8] * m[13] - m[9] * m[12])) *
                 -invDet;

  result.m[13] = (m[0] * (m[9] * m[14] - m[10] * m[13]) - m[1] * (m[8] * m[14] - m[10] * m[12]) +
                  m[2] * (m[8] * m[13] - m[9] * m[12])) *
                 invDet;

  result.m[14] = (m[0] * (m[5] * m[14] - m[6] * m[13]) - m[1] * (m[4] * m[14] - m[6] * m[12]) +
