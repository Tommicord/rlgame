                                ...
                                const size_t     outputSize)
{
        ...
        vkMapMemory(device, vertexBuffer.getMemory(), vertexBuffer.getOffset(), bufferSize, 0,
                    &data);
                            ...
                            GameVulkanFence&           fence)
{
        ...
        vkCmdPushConstants(commandBuffer.getCommandBuffer(), pipelineLayout,
                           VK_SHADER_STAGE_COMPUTE_BIT, 0, sizeof(WorldMeshGenPushConstants),
                           params);
