    ...
    computeCommandBuffer(device, commandPool)
{
  ...
  indexBufferHandle.setUsage(GameOpaqueBufferUsage::StorageBuffer |
                             GameOpaqueBufferUsage::TransferSrc |
                             GameOpaqueBufferUsage::TransferDst);
  indexBufferHandle.setMemoryProperty(GameOpaqueBufferMemoryProperty::HostVisible |
...
{
  WorldMeshDelaunay2DPResource* resource   = static_cast<WorldMeshDelaunay2DPResource*>(pResource);
