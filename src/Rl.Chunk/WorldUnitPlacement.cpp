...
void WorldUnitPlacement::initPermutationTables(VkDevice device, VkPhysicalDevice physicalDevice)
{
        ...
        vkCmdPipelineBarrier(computeCommandBuffer.getCommandBuffer(),
                             ...
                             0, 0, nullptr, permBarriers.size(), permBarriers.data(), 0, nullptr);
                                  ...
                                  GameVulkanFence&           fence)
{
        ...
        vkCmdDispatch(computeCommandBuffer.getCommandBuffer(), groupCountX, groupCountY,
                      groupCountZ);
                                        ...
                                        size_t           outputSize)
{
        ...
        void* data;
        vkMapMemory(device, stagingBuffer.getMemory(), stagingBuffer.getOffset(), outputSize, 0,
                    &data);
...
void WorldUnitPlacement::createDescriptorPool(VkDevice device)
{
        ...
        poolSizes[0].descriptorCount =
            5; // planet, unitRegistry, biomeRegistry, perm, permGradIndex3D
                                            ...
                                            const WorldPlanetData& planet)
{
        ...
        void* data;
        vkMapMemory(device, stagingBuffer.getMemory(), stagingBuffer.getOffset(),
                    sizeof(WorldPlanetData), 0, &data);
...
void WorldUnitPlacement::createUnitOutputImage(VkDevice device, VkPhysicalDevice physicalDevice)
{
        ...
        vkCmdPipelineBarrier(
            computeCommandBuffer.getCommandBuffer(), VK_PIPELINE_STAGE_TOP_OF_PIPE_BIT,
