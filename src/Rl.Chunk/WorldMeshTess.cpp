...
void WorldMeshTess::createDescriptorSets()
{
        ...
        if (occlusionCull)
        {
                ...
                const GameVulkanImageView& imageView =
                    occlusionCull->getVisibilityOutputImageView();
...
void WorldMeshTess::createPipeline()
{
        ...
        {
                computeShader = GameShaderLoader::createShaderModule(
                    device, WorldMeshTessNoOcclusionComp_data, WorldMeshTessNoOcclusionComp_size);
        }
                             ...
                             GameVulkanFence&           fence)
{
        ...
        vkCmdPushConstants(commandBuffer.getCommandBuffer(), pipelineLayout,
                           VK_SHADER_STAGE_COMPUTE_BIT, 0, sizeof(WorldMeshTessPushConstants),
                           params);
