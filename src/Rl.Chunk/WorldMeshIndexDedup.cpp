...
{
  WorldMeshIndexDedupPResource* resource   = static_cast<WorldMeshIndexDedupPResource*>(pResource);
  ...
  vkCmdPipelineBarrier(readCmd.getCommandBuffer(), VK_PIPELINE_STAGE_COMPUTE_SHADER_BIT,
                       VK_PIPELINE_STAGE_HOST_BIT, 0, 0, nullptr, 1, &countReadBarrier, 0, nullptr);
  readCmd.end();
