...
{
  createBasemapChannelImage(device, physicalDevice, basemapElevationImage, VK_FORMAT_R8_UNORM);
  createBasemapChannelImage(device, physicalDevice, basemapTemperatureImage, VK_FORMAT_R8_UNORM);
...
{
  createDeepmapChannelImage(device, physicalDevice, deepmapElevationImage, VK_FORMAT_R8_UNORM);
  createDeepmapChannelImage(device, physicalDevice, deepmapTemperatureImage, VK_FORMAT_R8_UNORM);
