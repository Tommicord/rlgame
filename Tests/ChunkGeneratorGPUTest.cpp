...
{
    BiomeNoiseLayer temperatureLayer = {1.1, 0.5f, 0.2f, 0.9f, 3, 1.0, 1.5f, 1, 1.4};
...
protected:
    void SetUp() override
    {
        ...
        vkQueueSubmit(game.GetMainBinding().graphicsQueue, 1, &submitInfo,
                      VK_NULL_HANDLE);
    ...
    void TearDown() override
    {
        ...
        // The generator shutdown should clean up all GPU resources before device
        // destruction
    }
    ...
    bool SubmitAndWait()
    {
        ...
        if (vkQueueSubmit(game.GetMainBinding().graphicsQueue, 1, &submitInfo,
